	...
	<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
		...
		<ul class="nav navbar-nav navbar-right ml-auto">			
			...
			<li class="nav-item text-center">
                ...
                <ul class="dropdown-menu form-wrapper center">
                    <div class="form-group">
                        <li class="text-center"><button type="text" class="btn btn-success" value=""><a href="C:\Users\sudil\Desktop\PAF\UI\signup.html">Register as a Doctor</a></button></li>
                    </div>
                    <div class="form-group">
                        <li class="text-center"><button type="text" class="btn btn-success" value="">Register as a Patient</button></li>
                    </div>
                    <div class="form-group">
                        <li class="text-center"><button type="text" class="btn btn-success" value="">Register as a Hospital</button></li>
                    </div>
                </ul>
			</li>
		</ul>
